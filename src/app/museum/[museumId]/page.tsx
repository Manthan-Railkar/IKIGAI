  ...
  return (
    <div className="noise-bg min-h-screen bg-[#0d0f12] text-white select-none relative overflow-x-hidden pb-32">
      ...
      <div className="fixed bottom-6 left-0 right-0 z-40 px-4 flex justify-center pointer-events-none">
        <div className="pointer-events-auto flex items-center justify-between gap-4 sm:gap-8 px-6 py-3.5 rounded-full border border-white/20 bg-[#15181e]/90 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.85),0_0_30px_rgba(255,199,90,0.2)] max-w-xl w-full">
          <div className="flex items-center gap-3">
            <div className="w-3 h-3 rounded-full bg-[#ffc75a] animate-ping" />
            <div className="text-left">
              <span className="block text-xs font-bold font-grotesque text-white leading-tight">
                Physical Artefact Scanner
              </span>
              <span className="block text-[10px] font-mono text-white/50 uppercase">
                Find hidden instruments in gallery
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="btn-hero-fill flex items-center gap-2 py-2.5 px-5 rounded-full border border-white text-white font-grotesque text-xs font-bold uppercase tracking-wider transition-all duration-300 shadow-md cursor-pointer hover:border-[#ffc75a] hover:text-[#ffc75a]"
          >
            <svg
              className="w-4 h-4"
              fill="none"
